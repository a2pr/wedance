...
export const LOTTERY_DRAW_MORE_INFO = 'Mais informações no nosso Instagram'
export const LOTTERY_TICKET_NUMBERS_NOTICE =
  'Seus números serão enviados pelo WhatsApp após a confirmação do comprovante.'
